...
\clearpage
\subsection{空振記録を基にした噴火パラメータの推定}\label{AcointPara}
...
Attempts have been made to estimate physical processes and parameters of the eruption by using signals of the infrasound observations and combining other physical observations.
For explosive eruption, it is assumed that the source is a simple monopole source \citep{Lighthill1978} and a method for estimating the cumulative volume has been proposed \citep{Johnson 2003}. Using this method, infrasound-derived gas volume has been compared with other observation parameters.
%ここまで
