...
During Stromboli eruptions, it is thought that the large gas bubbles rise in the low viscous magma and rupture on the surface.
With rupture of large bubbles, infrasound with a duration of about several seconds was observed.
%ここ以降は未編集
At \cite {Vergniolle 1996b}, we made an airborne observation at Stromboli Island (Italy) in 1992. In this observation, a microphone made by Br \ "uel - Kj \ ar (Type 4155, 1 Hz - 70 kHz, Type 4165, 4 Hz - 20 kHz), the airspeed was recorded with 1 kHz sampling at three observation points (two points at about 250 m from the east crater and one at about 370 m).
Stromboli at this time seems to be able to see the magma at the west crater and confirm the rupture of the foam, while the activity of the east crater was comparatively calm.
A waveform like Fig. \ Ref {Verg 19961fig1} a is observed along with the air shock observed during the explosion at the east crater, and in the main phase it has a peak at about 10 Hz (Fig. \ Ref {Verg 19961fig1 } c). As a mechanism to explain this waveform, in \ cite {Vergniolle 1996c}, bubble film vibration before bubble rupture is proposed.
On the other hand, according to direct observation of the bubble film movement speed in the expansion process of large bubbles using radar observation in recent years, vibration of the membrane is not measured, and in the case of the large bubbles, the dilute phase of the air- It is estimated that the characteristic frequency is bursting before the beginning, and that the characteristic frequency is the resonance of the hollow portion left on the surface after the rupture of the membrane (Fig. \ Ref {gerst 2013 f 14}).
...
On Sakurajima where intermittent Vulcanian eruptions occurred, from July to December 2011, infrasound observations were carried out for the eruption of the Showa crater. 
It has been reported that infrasound during generation of eruption columns has two characteristic peak frequency (0.2 - 0.5 Hz and 1 - 2 Hz).
